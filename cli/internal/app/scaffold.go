...
// -ldflags "-X github.com/josecabralf/taboo/cli/internal/app.libraryVersion=vX.Y.Z".
// The v0.0.0 default marks an
...
// comment followed by the seven entries taboo writes runtime state to.
