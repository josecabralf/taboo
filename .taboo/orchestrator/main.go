...
const usage = "usage: afk implement --issue <n> | afk review --pr <n> | afk plan | afk write-pr [--branch <branch>] [--ready] | afk update-branch --pr <n> | afk loop [--max-iterations <n>] [--parallelism <n>] [--dry-run]"
