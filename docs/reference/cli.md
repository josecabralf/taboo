...
|---|---|---|
| `--agent` | `""` | Agent to scaffold for (`opencode`, `claude-code`, `github-copilot`, `codex`). Required non-interactively. |
...
`unknown agent "X"; valid agents: claude-code, codex, github-copilot, opencode`
