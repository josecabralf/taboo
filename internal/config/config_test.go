...
// Precedence (override → workflow → defaults) is covered end-to-end by the
// config package's plan_test.go, which exercises the cmp.Or chain in Plan.
