...
func TestOpenCode_Name(t *testing.T) {
	if got := NewOpenCode(openCodeModel).Name(); got != OpenCode {
		t.Errorf("Name() = %q, want %q", got, OpenCode)
	}
}

func TestOpenCode_BuildCommand(t *testing.T) {
	ac := NewOpenCode(openCodeModel).BuildCommand(CommandOptions{Prompt: "do the thing"})
...
func TestOpenCode_BuildCommand_UsesModel(t *testing.T) {
	ac := NewOpenCode("anthropic/claude").BuildCommand(CommandOptions{Prompt: "go"})
...
func TestOpenCode_BuildCommand_Resume(t *testing.T) {
	ac := NewOpenCode(openCodeModel).BuildCommand(CommandOptions{
...
func TestOpenCode_BuildCommand_ForkWithoutResumeIgnored(t *testing.T) {
	ac := NewOpenCode(openCodeModel).BuildCommand(CommandOptions{Prompt: "go", Fork: true})
...
func TestOpenCode_BuildCommand_EmptyPromptOmitted(t *testing.T) {
	ac := NewOpenCode(openCodeModel).BuildCommand(CommandOptions{ResumeSession: "ses_abc"})
...
func TestOpenCode_CredentialEnvKeys(t *testing.T) {
	got := NewOpenCode(openCodeModel).CredentialEnvKeys()
...
func TestOpenCode_Sessions(t *testing.T) {
	spec, ok := NewOpenCode(openCodeModel).Sessions()
	if !ok {
