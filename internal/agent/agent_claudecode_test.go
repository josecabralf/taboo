...
func TestClaudeCode_Name(t *testing.T) {
	if got := NewClaudeCode(claudeCodeModel).Name(); got != ClaudeCode {
		t.Errorf("Name() = %q, want %q", got, ClaudeCode)
	}
}

func TestClaudeCode_BuildCommand(t *testing.T) {
	ac := NewClaudeCode(claudeCodeModel).BuildCommand(CommandOptions{Prompt: "do the thing"})
...
func TestClaudeCode_BuildCommand_UsesModel(t *testing.T) {
	ac := NewClaudeCode("claude-opus-4-8").BuildCommand(CommandOptions{Prompt: "go"})
...
func TestClaudeCode_BuildCommand_Resume(t *testing.T) {
	ac := NewClaudeCode(claudeCodeModel).BuildCommand(CommandOptions{
...
func TestClaudeCode_BuildCommand_ForkWithoutResumeIgnored(t *testing.T) {
	ac := NewClaudeCode(claudeCodeModel).BuildCommand(CommandOptions{Prompt: "go", Fork: true})
...
func TestClaudeCode_BuildCommand_EmptyPrompt(t *testing.T) {
	ac := NewClaudeCode(claudeCodeModel).BuildCommand(CommandOptions{ResumeSession: "ses_abc"})
...
func TestClaudeCode_CredentialEnvKeys(t *testing.T) {
	got := NewClaudeCode(claudeCodeModel).CredentialEnvKeys()
...
func TestClaudeCode_Sessions(t *testing.T) {
	spec, ok := NewClaudeCode(claudeCodeModel).Sessions()
	if !ok {
